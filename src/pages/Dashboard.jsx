...
const Dashboard = () => {
  const chartData = {
    labels: [
      "plane", "helicopter", "boat", "train", "subway", "bus", "car", 
      "moto", "bicycle", "horse", "skateboard", "others"
    ],
    datasets: [
      {
        label: "Norway",
    ...
    <div className="p-6 h-screen w-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        ...
        <div className="col-span-1 p-6 shadow-lg">
          <h2 className="text-xl font-semibold text-purple-600 mb-4">Campaign</h2>
          <Doughnut data={doughnutData} />
          <p className="text-xl mt-4">$48,352 revenue generated</p>
          <p className="text-sm text-gray-600">Includes extra misc expenditures and costs</p>
        </div>

        {/* Sales Quantity (Bar Chart) */}
        <div className="col-span-1 p-6 shadow-lg">
          <h2 className="text-xl font-semibold text-purple-600 mb-4">Sales Quantity</h2>
          <Bar data={salesData} />
        </div>

        {/* World Sales Map */}
         <div className="col-span-1 p-6 shadow-lg">
      <h2 className="text-xl font-semibold text-purple-600 mb-4">Global Sales Distribution</h2>
      <ComposableMap>
        <ZoomableGroup>
          ...
          <Marker coordinates={yourLocation.coordinates}>
            <circle r={8} fill="#F53" />
            <text textAnchor="middle" y={yourLocation.markerOffset} style={{ fontSize: 14, fill: "#000" }}>
              {yourLocation.name}
            </text>
          </Marker>
        </ZoomableGroup>
